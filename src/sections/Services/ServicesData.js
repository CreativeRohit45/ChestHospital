...
import iconfive from '../../assets/features/4.png';

const ServicesData = [
  {
    icon: iconOne,
    title: "Asthma & Allergy",
    description: "We offer personalized care plans and advanced diagnostics to help patients effectively manage asthma and allergy symptoms for a better quality of life."
  },
  {
    icon: iconTwo,
    title: "Branchoscopy",
  ...
  },
  {
    icon: iconThree,
    title: "Bronchitis",
    description: "Our clinic specializes in treating acute and chronic bronchitis with comprehensive respiratory assessments and targeted therapies."
  },
  {
    icon: iconFour,
